    ...
    <main class="relative h-screen flex flex-1 flex-col overflow-hidden px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative flex flex-1 flex-col items-center justify-center pb-16 pt-12">
            <div class="max-w-sm px-8 shadow-2xl drop-shadow-lg rounded-lg">
                ...
                <form action="/password/email" class="w-full pb-8">
                    <div class="">
                        <label for="email-address" class="block text-sm font-semibold leading-6 text-gray-900">Email address</label>
                        <input type="email" id="email-address" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 
                ...
                <div class="space-y-0 text-sm pb-3 pt-7 text-gray-900 flex items-center justify-center space-x-4">
                    <p class="text-center sm:text-left">Don't have an account?</p>
                    <a class="inline-flex justify-center rounded-lg text-sm font-semibold py-2.5 px-4 text-slate-900 ring-1 ring-slate-900/10 hover:ring-slate-900/20" href="/signup">
