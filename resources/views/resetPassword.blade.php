    ...
    <main class="relative h-screen flex flex-1 flex-col overflow-hidden px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative flex flex-1 flex-col items-center justify-center pb-16 pt-12">
            <div class="max-w-sm w-full px-8 shadow-2xl drop-shadow-lg rounded-lg">
                ...
                <form action="/password/email" class="w-full pb-10">
                    <div class="mb-5 relative">
                        <label for="new-password" class="block text-sm font-semibold leading-6 text-gray-900">New Password</label>
                        <input type="password" id="new-password" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="confirm-password" class="mt-2 appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 
                        shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-slate-800 ring-1 
                        ring-slate-200" required="" autofocus="" value="">
                    </div>
